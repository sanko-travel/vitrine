          ...
          <div className="reveal">
            <div className="bg-white rounded-2xl shadow-md p-8 ring-1 ring-teal/5 h-full flex flex-col">
              ...
              <ul className="space-y-3 mb-8 flex-1">
                <li className="flex items-start gap-3 font-body text-gray-700 text-sm">
                  ...
                  12 nuits d'hébergement (Tokyo, Mont Fuji, Kyoto)
                </li>
                <li className="flex items-start gap-3 font-body text-gray-700 text-sm">
                  <svg className="w-5 h-5 text-teal flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                  </svg>
                  Guides francophones à Tokyo et Uji
                </li>
                <li className="flex items-start gap-3 font-body text-gray-700 text-sm">
                  <svg className="w-5 h-5 text-teal flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                  </svg>
                  Tous les trajets inter-villes inclus
                </li>
                <li className="flex items-start gap-3 font-body text-gray-700 text-sm">
                  <svg className="w-5 h-5 text-teal flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                  </svg>
                  Expériences uniques (sumo, onsen, cérémonie du thé)
                </li>
                <li className="flex items-start gap-3 font-body text-gray-700 text-sm">
                  <svg className="w-5 h-5 text-teal flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                  </svg>
                  Assistance sur place 24h/7
                </li>
              </ul>
