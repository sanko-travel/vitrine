    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <Link
            to="/creer-mon-voyage"
            className="bg-coral text-white font-body font-semibold text-sm px-6 py-2.5 rounded-full hover:bg-coral/90 transition-colors"
          >
            Je suis créateur
          </Link>
        </div>
      ...
      {menuOpen && (
        <div className="md:hidden bg-white border-t border-teal/10 px-6 py-4 flex flex-col gap-4 shadow-lg">
          ...
          <div className="flex items-center gap-4 mt-2">
            {[
              { name: 'Instagram', href: 'https://www.instagram.com/sankofatravelstud.io/', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-5 h-5"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="0.5" fill="currentColor" stroke="none"/></svg> },
              { name: 'WhatsApp', href: 'https://wa.me/message/CI4DWPH2ICMTD1', icon: <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M17.47 14.38c-.3-.15-1.76-.87-2.03-.97-.28-.1-.48-.15-.68.15-.2.3-.77.97-.94 1.17-.18.2-.35.22-.65.07-.3-.15-1.27-.47-2.42-1.49-.9-.8-1.5-1.78-1.67-2.08-.18-.3-.02-.46.13-.61.13-.13.3-.35.45-.52.15-.18.2-.3.3-.5.1-.2.05-.37-.02-.52-.08-.15-.68-1.64-.93-2.25-.25-.6-.5-.52-.68-.53h-.58c-.2 0-.52.07-.8.37-.27.3-1.04 1.02-1.04 2.49s1.07 2.88 1.22 3.08c.15.2 2.1 3.2 5.08 4.49.71.31 1.27.49 1.7.63.71.23 1.36.2 1.87.12.57-.08 1.76-.72 2.01-1.41.25-.7.25-1.3.18-1.42-.08-.13-.28-.2-.58-.35zM12.05 21.5c-1.8 0-3.55-.48-5.08-1.4l-.36-.22-3.78.99 1.01-3.69-.24-.38A9.44 9.44 0 012.5 12.05C2.5 6.8 6.8 2.5 12.05 2.5c2.55 0 4.95 1 6.76 2.8a9.5 9.5 0 012.8 6.75c0 5.25-4.3 9.55-9.56 9.55zM12.05.5C5.7.5.5 5.7.5 12.05c0 2.04.54 4.03 1.56 5.78L.5 23.5l5.8-1.52A11.46 11.46 0 0012.05 23.5c6.35 0 11.55-5.2 11.55-11.55C23.6 5.6 18.4.5 12.05.5z"/></svg> },
          ...
          <Link
            to="/creer-mon-voyage"
            onClick={() => setMenuOpen(false)}
            className="bg-coral text-white font-body font-semibold text-sm px-6 py-2.5 rounded-full text-center mt-2 hover:bg-coral/90 transition-colors"
          >
            Je suis créateur
          </Link>
        </div>
