...
const gridItems = [
  ...
  { type: 'color', color: 'bg-blue-dark',   row: '2/3', col: '1/3' },
  ...
  { type: 'color', color: 'bg-orange',      row: '3/4', col: '6/9' },

  { type: 'color', color: 'bg-green-dark',  row: '4/5', col: '3/4' },
  ...
  { type: 'color', color: 'bg-orange',      row: '5/6', col: '11/12' },
