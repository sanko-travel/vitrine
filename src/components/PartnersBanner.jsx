const partners = [
  { name: 'Tesla', svg: (
    <svg viewBox="0 0 100 30" className="h-8 w-auto fill-blue-dark/50" xmlns="http://www.w3.org/2000/svg">
  ...
  { name: 'Patagonia', svg: (
    <svg viewBox="0 0 130 30" className="h-8 w-auto fill-blue-dark/50" xmlns="http://www.w3.org/2000/svg">
      <text x="0" y="24" fontFamily="Lexend, sans-serif" fontWeight="bold" fontSize="24">Patagonia</text>
    </svg>
  )},
  { name: 'Todoist', svg: (
    <svg viewBox="0 0 110 30" className="h-8 w-auto fill-blue-dark/50" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <section className="bg-beige py-16 px-6 overflow-hidden">
      <div className="max-w-6xl mx-auto mb-10 text-center">
        <h2 className="font-heading font-bold text-3xl text-blue-dark">
      ...
      <div className="overflow-hidden">
        <div className="marquee-track gap-16 items-center">
          ...
          {[...partners, ...partners].map((partner, i) => (
            <div key={i} className="flex-shrink-0 flex items-center px-6 opacity-50 hover:opacity-100 transition-opacity">
              {partner.svg}
            </div>
          ))}
        </div>
